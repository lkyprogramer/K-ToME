    ...
    private val specs: List<ValidationScenarioPresentationSpec> =
        listOf(
            ...
            ValidationScenarioPresentationSpec(
                ...
                titleKey = "validation.phase4.v4.dark-uiux-pr02-ui-chrome-sprite-pilot.title",
                startupMode = ValidationScenarioStartupMode.DIRECT_VALIDATION_SESSION,
                initialOverlaySection = ValidationOverlaySection.PHASE4_V4_FAST,
            ),
            ValidationScenarioPresentationSpec(
                id = ValidationScenarioId("dark-uiux-pr02-1-demo-shell-foundation"),
                titleKey = "validation.phase4.v4.dark-uiux-pr02-1-demo-shell-foundation.title",
                startupMode = ValidationScenarioStartupMode.DIRECT_VALIDATION_SESSION,
                initialOverlaySection = ValidationOverlaySection.PHASE4_V4_FAST,
            ),
            ValidationScenarioPresentationSpec(
                id = ValidationScenarioId("dark-uiux-pr03-equipment-inventory-items"),
                titleKey = "validation.phase4.v4.dark-uiux-pr03-equipment-inventory-items.title",
                startupMode = ValidationScenarioStartupMode.DIRECT_VALIDATION_SESSION,
                initialOverlaySection = ValidationOverlaySection.PHASE4_V4_FAST,
            ),
            ValidationScenarioPresentationSpec(
            ...
            ValidationScenarioPresentationSpec(
                ...
                titleKey = "validation.phase4.v4.phase4-v4-pr07.title",
                startupMode = ValidationScenarioStartupMode.DIRECT_VALIDATION_SESSION,
                initialOverlaySection = ValidationOverlaySection.PHASE4_V4_FAST,
            ),
        )
