    ...
    fun sessionLoad(snapshot: RenderSnapshot) {
        ...
        val interactionAudioKeys =
            linkedSetOf(
                ...
                "audio.damage.fire_hit",
                "audio.damage.cold_hit",
                "audio.damage.lightning_hit",
                "audio.damage.holy_hit",
                "audio.damage.shadow_hit",
                "audio.resource.stamina.spend",
                "audio.resource.stamina.restore",
                "audio.resource.mana.spend",
                "audio.resource.mana.restore",
                "audio.resource.energy.spend",
                "audio.resource.energy.restore",
                "audio.resource.positive_energy.spend",
