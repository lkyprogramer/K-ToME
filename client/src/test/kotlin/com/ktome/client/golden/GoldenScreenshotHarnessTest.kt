...
class GoldenScreenshotHarnessTest {
    ...
    fun `golden screenshot hashes remain stable for english and chinese formal screens`() {
        ...
        assertEquals(
            listOf(
                ...
                "26423e8f7a0559861408bd249ac36e70089d9154c98cb0ceffbea134009e7b84",
                ...
                "03668744cbdfc2ce5a7ec157403c015dfc849ff8efb4c422a79a0fd194b1623f",
    ...
    fun `boss warning golden hashes remain stable for english and chinese`() {
        ...
        assertEquals(
            listOf(
                "4e837679a161e3a1db6fcac0d571e2e26d0d4c61507fada6ce1e9e58216cfbfd",
                "ca3bf911346ff73c5573da1ff2d22ec492dea9ab99cbfd48c4b8f209ed4538e7",
            ),
    ...
    fun `route midpoint rogue golden hashes remain stable for english and chinese`() {
        ...
        assertEquals(
            listOf(
                ...
                "c6ff0f73187d2791080e22f88e8a9bbd42bdb68c316f7ed597bac2a7815668d9",
                ...
                "a3e30dfdc59fab2dfb7caf36c8a9b09b7e1b23a7b0663ebdd013af10465a1795",
    ...
    fun `outcome recap golden hashes remain stable for english and chinese`() {
        ...
        assertEquals(
            listOf(
                ...
                "c8d363627d63da7982cacb04f31b1631903c69fa4cc74fec0964f85838dd0a4b",
            ),
            english + chinese,
        )
    }
