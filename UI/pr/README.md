...
| PR-02-2 | ui-demo-new visual parity / shell demo evidence | `ui-demo-new-*` golden labels remain upstream evidence; `actor.vanguard` and `prop.stairs.down` remain PR-02-2 owner keys, while first-screen ruins floor/wall keys are superseded by PR-08 owner coverage; consumed by PR-06 final-full as upstream-covered entries |
...
| PR-02-2 | `ui-demo-new-parity-*` labels and `build/reports/verification/dark-uiux/dark-v1-manifest-coverage-pr02-2-owner-scope.json` for actor/prop owner keys after PR-08 supersession; source manual remains `UI/manual-records/ui-demo-new-visual-parity.md` |
