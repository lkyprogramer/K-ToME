...
download_main_artifact_with_module "mavenCentral" "com.badlogicgames.gdx" "gdx-freetype" "$LIBGDX_VERSION"
...
download_classifier_jar "mavenCentral" "com.badlogicgames.gdx" "gdx-freetype-platform" "$LIBGDX_VERSION" "natives-desktop"
download_pom_only "mavenCentral" "com.badlogicgames.gdx" "gdx-freetype-platform" "$LIBGDX_VERSION"
