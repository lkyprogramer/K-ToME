...
class ReportPhase4BuildContractTest {
    ...
    fun `phase4 aggregate helper keeps reportPhase4 artifact only semantics`() {
        ...
        assertTrue(buildScript.contains("ktome.phase4.aggregationManifestMode"))
        assertTrue(buildScript.contains("phase4LegacyLiteralProducerArtifactRelativePaths"))
        assertTrue(buildScript.contains("phase4LegacyLiteralProducerTaskPaths"))
