...
internal object LintFixtures {
    ...
    private val directLocaleLiteralPattern =
        """"((?:ui|log|stairs|status|ai|damage_type|terrain|shop\.purchase|validation\.phase4\.v4)\.[A-Za-z0-9_.-]+|(?:actor|profession|race|inscription|talent_tree|talent|monster|boss|shop|difficulty|material|affix|interactable|prop)\.[A-Za-z0-9_.-]+\.(?:name|desc|role|resource_hint)|mutation\.[A-Za-z0-9_.-]+\.(?:name|desc)|zone\.[A-Za-z0-9_.-]+\.(?:name|desc|role)|zone\.mechanic_hint\.[A-Za-z0-9_.-]+|zone\.trigger\.[A-Za-z0-9_.-]+|objective\.[A-Za-z0-9_.-]+\.(?:name|desc|role)|objective\.[A-Za-z0-9_.-]+\.step\.[A-Za-z0-9_.-]+|item\.[A-Za-z0-9_.-]+\.(?:name|desc|role)|item\.(?:quality|display)\.[A-Za-z0-9_.-]+|monster\.tag\.[A-Za-z0-9_.-]+)""""
            .toRegex()
    ...
    val schemaResources: List<String> =
        listOf(
            ...
            "/data/elites/index.yaml",
            "/data/boss-variants/index.yaml",
            "/data/events/index.yaml",
            "/data/secret-zones/index.yaml",
